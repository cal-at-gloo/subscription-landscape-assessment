...
- **`subscription-landscape-assessment.html`** — Full research document. Open in any browser. Includes:
...
Open `subscription-landscape-assessment.html` in a browser. No build step or dependencies required.
